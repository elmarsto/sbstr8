...
export const filterByTags =
  (tags?: string[]) => (posts: CookedPostMetadata[]) => {
...
export const filterByCategories =
  (categories?: string[]) => (posts: CookedPostMetadata[]) => {
...
export const filterBySlug =
  (slugs?: string[]) => (posts: CookedPostMetadata[]) => {
...
export const filterByAuthors =
  (authorEmailAddresses?: string[]) => (posts: CookedPostMetadata[]) => {
...
export const filterByContributors =
  (contributorEmailAddresses?: string[]) => (posts: CookedPostMetadata[]) => {
...
export const filterByDateCreated =
  (dateRange?: DateRange) => (posts: CookedPostMetadata[]) => {
